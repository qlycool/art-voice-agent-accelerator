...
from rtagents.RTAgent.backend.agents.tool_store.functions_helper import _json
...
async def escalate_emergency(args: EscalateEmergencyArgs) -> str:
    ...
    return _json(True, "Escalation to human insurance agent triggered.", reason=reason, handoff="human_agent")
