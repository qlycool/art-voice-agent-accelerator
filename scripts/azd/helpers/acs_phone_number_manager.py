...
def main():
    parser = argparse.ArgumentParser(description='Manage Azure Communication Services phone numbers')
    ...
    purchase_parser.add_argument('--phone-number-type', choices=['TOLL_FREE', 'GEOGRAPHIC'], 
                                default='TOLL_FREE', help='Phone number type (default: TOLL_FREE)')
