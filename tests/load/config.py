...
class TestConfig:
    ...
    api_base_url: str = os.getenv(
        "API_BASE_URL", "https://rtmedagent-api.azurewebsites.net"
    )
    websocket_base_url: str = os.getenv(
        "WS_BASE_URL", "wss://rtmedagent-api.azurewebsites.net"
    )
...
class TestDataGenerator:
    ...
    def generate_call_data() -> Dict[str, Any]:
        ...
        return {
            ...
            "appointment_type": random.choice(
                ["general_consultation", "follow_up", "urgent_care", "mental_health"]
            ),
        }
    ...
    def generate_websocket_message(message_type: str) -> Dict[str, Any]:
        ...
        if message_type == "audio_chunk":
            ...
            base_message.update({"language": "en-US", "interim_results": True})
